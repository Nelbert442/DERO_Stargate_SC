...
```
curl -X POST http://127.0.0.1:30309/json_rpc -H 'Content-Type: application/json' -d '{"jsonrpc":"2.0","id":"0","method":"transfer_split","params":{"mixin":5,"get_tx_key":true,"sc_tx":{"entrypoint":"Withdraw","scid":"c03ae7d3fc72019cdf4d71729c9da076943d7eef1637f5420ff25cf5232bb172" }}}"'
```
...
```
curl -X POST http://127.0.0.1:30309/json_rpc -H 'Content-Type: application/json' -d '{"jsonrpc":"2.0","id":"0","method":"transfer_split","params":{"mixin":5,"get_tx_key":true,"sc_tx":{"entrypoint":"TuneTimeBoxParameters","scid":"c03ae7d3fc72019cdf4d71729c9da076943d7eef1637f5420ff25cf5232bb172", "params":{ "block_between_withdraw":"150", "sc_giveback":"9500" } }}}"'
```
